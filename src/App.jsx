        ...
        {socialBtns.length > 0 && (
          <div style={{ display: "flex", gap: 10, marginTop: 14, flexWrap: "wrap" }}>
            {socialBtns.map((btn, i) => (
              <a key={i} href={btn.url} target="_blank" rel="noopener noreferrer" style={{ display: "flex", textDecoration: "none" }}>
                {btn.icon}
              </a>
            ))}
          </div>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", gap: 24 }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 16, flexWrap: "wrap", alignItems: "center" }}>
              {socialBtns.map((btn, i) => (
                <a key={i} href={btn.url} target="_blank" rel="noopener noreferrer" style={{ display: "flex", textDecoration: "none", opacity: 0.85, transition: `opacity 0.15s` }}
